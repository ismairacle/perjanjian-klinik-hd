...
<form name ="input_form" id="myForm" action="kirim.php" method="POST">
	...
	<div class="form-group">
	<label for="usr">Penghasilan<span style="color: red">*</span></label>
	<div class="input-group">

	<div class="input-group-addon"><b class="lbl">Rp.</b></div>
	<input type="text" name= "penghasilan" inputmode="numeric" class="form-control price penghasilan" id="penghasilan" required> 
	</div>
